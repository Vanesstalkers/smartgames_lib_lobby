...
function addEvents(self) {
  /* все эти манипуляциии для того, чтобы внутри функций в self остался vue-компонент,
  но при этом сохранилась бы ссылка на функцию для корректного удаления ее в removeEvents */
  Object.assign(events, {
    resizeBG() {
      const bgHeight = 256;
      const bgWidth = 512;
      self.bg.top = window.innerHeight / 2 - bgHeight / 2;
      self.bg.bottom = window.innerHeight / 2 + bgHeight / 2;
